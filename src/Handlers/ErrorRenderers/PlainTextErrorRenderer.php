...
class PlainTextErrorRenderer extends AbstractErrorRenderer
{
    ...
    public function __invoke()
    {
        ...
        $text = 'Application Error:' . PHP_EOL;

        $text .= sprintf('Code: %s' . PHP_EOL, $e->getCode());
        $text .= sprintf('Message: %s' . PHP_EOL, htmlentities($e->getMessage()));
     ...
     * @return string
     */
    protected function formatExceptionFragment( $e )
    {
